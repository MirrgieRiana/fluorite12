...
sealed class RightBracketsNode(val receiver: Node, val left: TokenMatch, val argument: Node, val right: TokenMatch) : Node()
class RightBracketsRoundNode(receiver: Node, left: TokenMatch, argument: Node, right: TokenMatch) : RightBracketsNode(receiver, left, argument, right)
class RightBracketsSquareNode(receiver: Node, left: TokenMatch, argument: Node, right: TokenMatch) : RightBracketsNode(receiver, left, argument, right)
class RightBracketsCurlyNode(receiver: Node, left: TokenMatch, argument: Node, right: TokenMatch) : RightBracketsNode(receiver, left, argument, right)

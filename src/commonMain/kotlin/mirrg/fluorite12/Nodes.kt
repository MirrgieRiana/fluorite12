...
sealed class RightArrowBracketsNode(val receiver: Node, val left: TokenMatch, val arguments: Node, val arrow: List<TokenMatch>, val body: Node, val right: TokenMatch) : Node()
...
sealed class RightBracketsNode(val receiver: Node, val left: TokenMatch, val body: Node, val right: TokenMatch) : Node()

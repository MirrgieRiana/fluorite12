...
sealed class AbstractBracketsNode(val left: TokenMatch, val body: Node, val right: TokenMatch) : Node()
sealed class AbstractBracketsLiteralNode(left: TokenMatch, body: Node, right: TokenMatch) : AbstractBracketsNode(left, body, right)
sealed class ArrowBracketsNode(left: TokenMatch, val arguments: Node, val arrow: List<TokenMatch>, body: Node, right: TokenMatch) : AbstractBracketsLiteralNode(left, body, right)
...
sealed class BracketsNode(left: TokenMatch, body: Node, right: TokenMatch) : AbstractBracketsLiteralNode(left, body, right)
class BracketsRoundNode(left: TokenMatch, body: Node, right: TokenMatch) : BracketsNode(left, body, right)
class BracketsSquareNode(left: TokenMatch, body: Node, right: TokenMatch) : BracketsNode(left, body, right)
class BracketsCurlyNode(left: TokenMatch, body: Node, right: TokenMatch) : BracketsNode(left, body, right)
sealed class AbstractRightBracketsNode(val receiver: Node, left: TokenMatch, body: Node, right: TokenMatch) : AbstractBracketsNode(left, body, right)
sealed class RightArrowBracketsNode(receiver: Node, left: TokenMatch, val arguments: Node, val arrow: List<TokenMatch>, body: Node, right: TokenMatch) : AbstractRightBracketsNode(receiver, left, body, right)
class RightArrowBracketsRoundNode(receiver: Node, left: TokenMatch, arguments: Node, arrow: List<TokenMatch>, body: Node, right: TokenMatch) : RightArrowBracketsNode(receiver, left, arguments, arrow, body, right)
class RightArrowBracketsSquareNode(receiver: Node, left: TokenMatch, arguments: Node, arrow: List<TokenMatch>, body: Node, right: TokenMatch) : RightArrowBracketsNode(receiver, left, arguments, arrow, body, right)
class RightArrowBracketsCurlyNode(receiver: Node, left: TokenMatch, arguments: Node, arrow: List<TokenMatch>, body: Node, right: TokenMatch) : RightArrowBracketsNode(receiver, left, arguments, arrow, body, right)
sealed class RightBracketsNode(receiver: Node, left: TokenMatch, body: Node, right: TokenMatch) : AbstractRightBracketsNode(receiver, left, body, right)
class RightBracketsRoundNode(receiver: Node, left: TokenMatch, body: Node, right: TokenMatch) : RightBracketsNode(receiver, left, body, right)
class RightBracketsSquareNode(receiver: Node, left: TokenMatch, body: Node, right: TokenMatch) : RightBracketsNode(receiver, left, body, right)
class RightBracketsCurlyNode(receiver: Node, left: TokenMatch, body: Node, right: TokenMatch) : RightBracketsNode(receiver, left, body, right)
